...
CREATE FUNCTION cube_type_out(int4)
RETURNS cstring
AS 'MODULE_PATHNAME'
LANGUAGE C IMMUTABLE STRICT;
...
-- Typed wrappers
-- '(4,5),(1,2)'::cube("hgfjhgfjhgf")

CREATE FUNCTION cube_f4(float8[])
	RETURNS cube AS 'MODULE_PATHNAME', '_FLOAT4_cube_a_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_f4(float8[], float8[])
	RETURNS cube AS 'MODULE_PATHNAME', '_FLOAT4_cube_a_f8_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_f4(float8)
	RETURNS cube AS 'MODULE_PATHNAME', '_FLOAT4_cube_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_f4(float8, float8)
	RETURNS cube AS 'MODULE_PATHNAME', '_FLOAT4_cube_f8_f8' LANGUAGE C IMMUTABLE STRICT;
-- CREATE FUNCTION cube_in_f4(cstring)
	-- RETURNS cube_f4 AS 'MODULE_PATHNAME', '_FLOAT4_cube_in' LANGUAGE C IMMUTABLE STRICT;
-- CREATE FUNCTION cube_out_f4(cube_f4)
	-- RETURNS cstring AS 'MODULE_PATHNAME', '_FLOAT4_cube_out' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cube_i4(float8[])
	RETURNS cube AS 'MODULE_PATHNAME', '_INT4_cube_a_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i4(float8[], float8[])
	RETURNS cube AS 'MODULE_PATHNAME', '_INT4_cube_a_f8_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i4(float8)
	RETURNS cube AS 'MODULE_PATHNAME', '_INT4_cube_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i4(float8, float8)
	RETURNS cube AS 'MODULE_PATHNAME', '_INT4_cube_f8_f8' LANGUAGE C IMMUTABLE STRICT;
-- CREATE FUNCTION cube_in_i4(cstring)
-- 	RETURNS cube_i4 AS 'MODULE_PATHNAME', '_INT4_cube_in' LANGUAGE C IMMUTABLE STRICT;
-- CREATE FUNCTION cube_out_i4(cube_i4)
-- 	RETURNS cstring AS 'MODULE_PATHNAME', '_INT4_cube_out' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cube_i2(float8[])
	RETURNS cube AS 'MODULE_PATHNAME', '_INT2_cube_a_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i2(float8[], float8[])
	RETURNS cube AS 'MODULE_PATHNAME', '_INT2_cube_a_f8_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i2(float8)
	RETURNS cube AS 'MODULE_PATHNAME', '_INT2_cube_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i2(float8, float8)
	RETURNS cube AS 'MODULE_PATHNAME', '_INT2_cube_f8_f8' LANGUAGE C IMMUTABLE STRICT;
-- CREATE FUNCTION cube_in_i2(cstring)
-- 	RETURNS cube_i2 AS 'MODULE_PATHNAME', '_INT2_cube_in' LANGUAGE C IMMUTABLE STRICT;
-- CREATE FUNCTION cube_out_i2(cube_i2)
-- 	RETURNS cstring AS 'MODULE_PATHNAME', '_INT2_cube_out' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cube_i1(float8[])
	RETURNS cube AS 'MODULE_PATHNAME', '_INT1_cube_a_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i1(float8[], float8[])
	RETURNS cube AS 'MODULE_PATHNAME', '_INT1_cube_a_f8_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i1(float8)
	RETURNS cube AS 'MODULE_PATHNAME', '_INT1_cube_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i1(float8, float8)
	RETURNS cube AS 'MODULE_PATHNAME', '_INT1_cube_f8_f8' LANGUAGE C IMMUTABLE STRICT;
-- CREATE FUNCTION cube_in_i1(cstring)
-- 	RETURNS cube_i1 AS 'MODULE_PATHNAME', '_INT1_cube_in' LANGUAGE C IMMUTABLE STRICT;
-- CREATE FUNCTION cube_out_i1(cube_i1)
-- 	RETURNS cstring AS 'MODULE_PATHNAME', '_INT1_cube_out' LANGUAGE C IMMUTABLE STRICT;
