...
CREATE FUNCTION cube_f4(float8[])
	RETURNS cube_f4 AS 'MODULE_PATHNAME', '_FLOAT4_cube_a_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_f4(float8[], float8[])
	RETURNS cube_f4 AS 'MODULE_PATHNAME', '_FLOAT4_cube_a_f8_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_f4(float8)
	RETURNS cube_f4 AS 'MODULE_PATHNAME', '_FLOAT4_cube_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_f4(float8, float8)
	RETURNS cube_f4 AS 'MODULE_PATHNAME', '_FLOAT4_cube_f8_f8' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cube_i4(float8[])
	RETURNS cube_i4 AS 'MODULE_PATHNAME', '_INT4_cube_a_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i4(float8[], float8[])
	RETURNS cube_i4 AS 'MODULE_PATHNAME', '_INT4_cube_a_f8_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i4(float8)
	RETURNS cube_i4 AS 'MODULE_PATHNAME', '_INT4_cube_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i4(float8, float8)
	RETURNS cube_i4 AS 'MODULE_PATHNAME', '_INT4_cube_f8_f8' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cube_i2(float8[])
	RETURNS cube_i2 AS 'MODULE_PATHNAME', '_INT2_cube_a_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i2(float8[], float8[])
	RETURNS cube_i2 AS 'MODULE_PATHNAME', '_INT2_cube_a_f8_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i2(float8)
	RETURNS cube_i2 AS 'MODULE_PATHNAME', '_INT2_cube_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i2(float8, float8)
	RETURNS cube_i2 AS 'MODULE_PATHNAME', '_INT2_cube_f8_f8' LANGUAGE C IMMUTABLE STRICT;
...
CREATE FUNCTION cube_i1(float8[])
	RETURNS cube_i1 AS 'MODULE_PATHNAME', '_INT1_cube_a_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i1(float8[], float8[])
	RETURNS cube_i1 AS 'MODULE_PATHNAME', '_INT1_cube_a_f8_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i1(float8)
	RETURNS cube_i1 AS 'MODULE_PATHNAME', '_INT1_cube_f8' LANGUAGE C IMMUTABLE STRICT;
CREATE FUNCTION cube_i1(float8, float8)
	RETURNS cube_i1 AS 'MODULE_PATHNAME', '_INT1_cube_f8_f8' LANGUAGE C IMMUTABLE STRICT;
